...
<body>
  ...
  <div class="container">
    ...
    <form action="#" class="form" method="POST" enctype="multipart/form-data" autocomplete="off">
      <input required="" class="input" type="email" name="email" id="email" placeholder="E-mail" required>
      <input required="" class="input" type="password" name="password" id="password" required placeholder="Password">
      <div class="row"><span class="forgot-password"><a href="reset_password.php">Forgot Password ?</a></span><span class="forgot-password"><a href="index.php">Don't Have Account ?</a></span></div>
      <input  class="login-button" type="submit" name="submit" value="Continue to Chat"> -->
